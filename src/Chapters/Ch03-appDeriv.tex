...
\begin{center}
	\includegraphics[width=0.8\textwidth]{./images/ch03/antiRolle.jpg}
\end{center}
...
\begin{shaded}
	...
	\begin{center}
		\includegraphics[width=0.8\textwidth]{./images/ch03/Darboux.jpg}
	...
	\egz 设$f(x)$在$[a,b]$上满足Rolle定理条件，
	且$f\,'_+(a)f\,'_-(b)>0$，则$f\,'(x)=0$在$(a,b)$内至少有两个根。
	
	\begin{center}
		\includegraphics[width=0.5\textwidth]{./images/ch03/Darboux2.jpg}\\
		\kaishu 示意图
	\end{center}
...
\egz 证明方程$x^5+x-1=0$只有唯一实根。

\egz 证明：$\df{\ln x-\ln x_1}{x-x_1}<\df 1{x_1},\quad (0<x_1<x)$
...
\begin{shaded}
	...
	\egz 过点$(0,0),(1,2),(2,-1),(3,-2)$的Lagrange插值多项式为
...
\egz 设$a<b<c$，函数$f(x)$在$[a,c]$上二阶可导，证明：
存在$\xi\in(a,c)$，使得
$$
...
\begin{center}
	\resizebox{!}{3.5cm}{\includegraphics{./images/ch03/lim00.pdf}}
\end{center}
...
\begin{center}
	\includegraphics[width=9cm]{./images/ch03/1xsinx2.pdf}
...
\begin{shaded}
	...
	\end{array}\right.$$
	\begin{center}
		\includegraphics[width=0.6\textwidth]{./images/ch03/e-1x2.pdf}
	\end{center}
...
\begin{center}
	\resizebox{!}{5.5cm}{\includegraphics{./images/ch03/exse1.pdf}}\quad
	\resizebox{!}{5.5cm}{\includegraphics{./images/ch03/exse2.pdf}}
\end{center}
...
\egz 设$f(x)\in C^3[-1,1]$，且$f(-1)=0,f(1)=1,f'(0)=0$，
...
\begin{center}
	\resizebox{!}{5cm}{\includegraphics{./images/ch03/xpmSinx.pdf}}
...
\begin{center}
	\resizebox{!}{5cm}{\includegraphics{./images/ch03/xSinxx3.pdf}}
\end{center}
...
\begin{center}
	\resizebox{!}{4cm}{\includegraphics{./images/ch03/lnxArctanx.pdf}}\quad
	\resizebox{!}{4cm}{\includegraphics{./images/ch03/exTaylor.pdf}}
\end{center}
...
\begin{center}
 	\includegraphics[width=0.9\textwidth]{./images/ch03/convexCurve.jpg}
...
如图
\begin{center}
	\resizebox{!}{5cm}{\includegraphics{./images/ch03/fmm_pt.pdf}}
...
\begin{center}
	\resizebox{!}{4cm}{\includegraphics{./images/ch03/2x3.pdf}}\quad
	\resizebox{!}{4cm}{\includegraphics{./images/ch03/1xxe-x.pdf}}
...
% 	  	  \setlength{\itemindent}{1cm}
	...
	\begin{center}
		\resizebox{!}{5cm}{\includegraphics{./images/ch03/x123.pdf}}
	\end{center}
	...
	\begin{center}
		\resizebox{!}{5cm}{\includegraphics{./images/ch03/x124.pdf}}
	\end{center}
...
\begin{center}
	\resizebox{!}{4cm}{\includegraphics{./images/ch03/x36x2-5.pdf}}\quad
	\resizebox{!}{4cm}{\includegraphics{./images/ch03/cosxcos2x.pdf}}
...
\begin{center}
	\resizebox{!}{5cm}{\includegraphics{./images/ch03/x1x.pdf}}
\end{center}
...
\begin{center}
	\resizebox{!}{5cm}{\includegraphics{./images/ch03/2x2x.pdf}}
\end{center}
